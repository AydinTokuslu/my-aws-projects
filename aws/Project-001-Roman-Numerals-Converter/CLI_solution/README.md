...
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name first_key --security-groups roman_numbers_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data https://raw.githubusercontent.com/AydinTokuslu/my-aws-projects/main/aws/Project-001-Roman-Numerals-Converter/userdata.sh
